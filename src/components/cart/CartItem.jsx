...
const CartItem = ({ product, quantity, setQuantity }) => {
  ...
  const { handleWishlistToggle, handleCart } = useCartAndWishlist();
    ...
    >
      ...
      <div className="cart-item-details">
        ...
        <div className="quantity">
          ...
          {quantity}
          <button onClick={increaseQuantity} disabled={quantity === 6}>
            +
          </button>
        </div>
        <div className="cart-summary-buttons">
          ...
          <button className="cart-summary-btn" onClick={handleRemoveFromCart}>
            Remove
          </button>
        </div>
      </div>
